...
def parse_args():
    ...
    parser.add_argument('--testDataPath', type=str, default='E:/Datasets/probav_data/train/NIRtest',
                        help='Training dataset path')
    parser.add_argument('--normCsvFile', type=str, default='E:/Datasets/probav_data/norm.csv',
    ...
    parser.add_argument('--inImgPatchSize', type=int, default=384,
